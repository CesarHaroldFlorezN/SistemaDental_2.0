            ...
            {!planSeleccionado && formData.tipoPago === 'pago_ahora' && (
              <div className="mt-4 grid gap-4 rounded-xl border border-violet-500/20 bg-slate-900/55 p-4 sm:grid-cols-2">
                <label className="font-medium text-slate-300">
                  Monto recibido hoy
                  <input type="number" data-money-input="true" min="0" max={costoNumerico} step="0.01" name="montoPagado" value={formData.montoPagado} onChange={handleChange} className="mt-1.5 w-full rounded-xl border border-slate-700 bg-slate-900 px-3.5 py-2.5 text-right text-lg font-black text-violet-200 outline-none focus:border-violet-500" />
                </label>

...
export default function App() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-900 font-sans text-slate-100">
      ...
      <main className="min-w-0 flex-1 overflow-y-auto bg-slate-900 p-4 transition-colors duration-200 dark:bg-slate-900 light:bg-slate-100 sm:p-6 xl:p-8">
        
        <div className="mx-auto mb-4 flex max-w-[1800px] items-center justify-end">
